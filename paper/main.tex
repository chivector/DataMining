...
\input{sections/01_research_task}
\input{sections/02_prompt_matrix}
\input{sections/03_api_collection}
\input{sections/04_features_and_analysis}
\input{sections/05_analysis_framework}
...
\clearpage
\appendix
\input{sections/appendix_supplementary_materials}
